...
parser.add_argument("--non_mci_stationary_data_path", type=str, default='stationary_data/stationary_dataset_nonmci.csv')    

parser.add_argument("--mci_metadata_path", type=str, default='intermediate_files/mci_metadata.csv')    
parser.add_argument("--non_mci_metadata_path", type=str, default='intermediate_files/nonmci_metadata.csv')    
