...
# Initializing the variables
    ...
    with tf.compat.v1.Session(config=config) as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('saved_deep_learning_models/LSTM/'))
...
if __name__ == "__main__": main(idx, drp, epochs, reg_coeff, learning_rt, n_hid, batch_sz, test_data, n_targets)
